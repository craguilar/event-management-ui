...
export class EventRepository {
  ...
  waitUser = () => Auth.currentSession().then((res: CognitoUserSession) => {
  ...
  async get(id: string): Promise<Event> {
    ...
    return fetch(this.apiConfigurationParams.basePath + `/events/` + id, {
      headers: {
        ...
        'Authorization': 'Bearer ' + (this.apiConfigurationParams.accessToken != undefined ? this.apiConfigurationParams.accessToken : "-"),
      }
    }).then((response) => {
